 ...
 *
 * Building both shapes here is what keeps the OpenAPI document and the MCP
...
{
    /**
     * The body returned when a payload converted.
     *
    ...
    /**
     * The body returned when a payload was refused.
     *
